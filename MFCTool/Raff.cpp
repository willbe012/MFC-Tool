...
int CRaff::Update_Object()
{
	return 0;
}

void CRaff::Late_Update_Object()
{
}

void CRaff::Render_Object(CMFCToolView * _pView)
{
	// 좌표 계산
	Matrix_Check();
	Hitbox_Check();
	...
	// 이미지 렌더
	const TEXINFO* pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo(L"Raff");
...
void CRaff::Release_Object()
{
}

void CRaff::Matrix_Check()
{
	// 최소한의 기능
